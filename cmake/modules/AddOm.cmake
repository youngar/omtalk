...
function(add_om_target target)
	...
	if(OMTALK_CCACHE)
		set_target_properties(${target}
			PROPERTIES
				C_COMPILER_LAUNCHER ${OM_TOOL_CCACHE}
				CXX_COMPILER_LAUNCHER ${OM_TOOL_CCACHE}
		)
	endif()
	...
	if(OMTALK_STATIC_CLANG_TIDY)
		set_target_properties(${target}
			PROPERTIES
				C_CLANG_TIDY ${OM_TOOL_CLANG_TIDY}
				CXX_CLANG_TIDY ${OM_TOOL_CLANG_TIDY}
		)
	endif()
	...
	if(OM_STATIC_IWYU)
		set_target_properties(${target}
			PROPERTIES
				C_INCLUDE_WHAT_YOU_USE ${OM_IWYU_EXECUTABLE}
				CXX_INCLUDE_WHAT_YOU_USE ${OM_IWYU_EXECUTABLE}
		)
	endif()
