...
/// The klass loader will load a given file, plus it's dependencies, into
/// memory. Dependencies are determined by scanning the AST.
class KlassLoader {
public:
  KlassLoader() {}
...
inline KlassInfo createKlassInfo(parser::Klass &klass) {
  KlassInfo info;
